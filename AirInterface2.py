...
class AirInterface2:
    def __init__(self, lns: LNS, gateways, prop_model: PropagationModel, snr_model: SNRModel, sinr_model: SINRModel, env):
    ...
    def submit(self, packet: UplinkMessage):
        ...
        return self.packet_in_air(packet, available_gateways)

    def packet_in_air(self, packet: UplinkMessage, gateways):
    ...
    def packet_received(self, packet: UplinkMessage, gateway) -> bool:
